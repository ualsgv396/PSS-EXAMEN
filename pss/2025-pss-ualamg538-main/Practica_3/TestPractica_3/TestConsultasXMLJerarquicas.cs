...
{
    [TestClass]
    public sealed class TestConsultasXMLJerarquicas
    {
        private ConsultasXMLJerarquicas _consultasXML;
        ...
        public void Setup()
        {
            ...
            _consultasXML = new ConsultasXMLJerarquicas("DatosJerarquicos.xml");
        }
        ...
        public void XML_UsuariosTotalConexiones_DeberiaRetornarTotales()
        {
            ...
            Assert.IsNotNull(resultado);
            Assert.AreEqual(8, resultado.Count, "Debería haber 8 usuarios con conexiones");
        ...
        public void XML_TopUsuariosActivos_DeberiaRetornarTop10()
        {
            ...
            Assert.AreEqual(8, resultado.Count, "Hay 8 usuarios con conexiones");
        }
